    ...
    <div className="flex items-center justify-center">
      {isSystem ? (
        ...
        <div className="w-full flex">
          ...
          <div
            className={`
            rounded-s-md hover:bg-discord-darker flex flex-col m-1 border-l-1 border-t-1 border-discord-dark-gray w-full`}
          >
            <div>
            ...
            <p
              className={`
              p-2 text-white whitespace-pre-wrap break-words w-full min-w-0`}
            >
              {message.message}
            </p>
          </div>
